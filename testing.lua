...
local window, closebutton = puter.CreateWindow(250, 300, "DestroyBot")
local destroyBotFace = puter.AddWindowElement(window, "Frame", {
	Size = UDim2.fromOffset(250,250);
	Position = UDim2.fromOffset(0,0);
	BackgroundColor3 = Color3.fromRGB(0,0,0);
	BorderSizePixel = 0;
})
local destroyBotReaction = puter.AddWindowElement(window, "TextLabel", {
...
local talkButton = puter.AddWindowElement(window, "TextButton", {
...
local FEDDY = puter.AddElement(destroyBotFace, "ImageLabel",{
...
local EyeL = puter.AddElement(destroyBotFace, "Frame",{
	Size = UDim2.fromScale(0.1,0.1),
	Position = UDim2.fromScale(0.2,0.25),
	BorderSizePixel = 0
})

local EyeR = puter.AddElement(destroyBotFace, "Frame",{
	Size = UDim2.fromScale(0.1,0.1),
	Position = UDim2.fromScale(0.7,0.25),
	BorderSizePixel = 0
})

local AngerL = puter.AddElement(destroyBotFace, "Frame",{
...
local AngerR = puter.AddElement(destroyBotFace, "Frame",{
	Size = UDim2.fromScale(0.25,0.05),
...
local MouthMid = puter.AddElement(destroyBotFace, "Frame",{
	Size = UDim2.fromScale(0.25,0.05),
	Position = UDim2.fromScale(0.375,0.625),
	BorderSizePixel = 0
})

local PivotL = puter.AddElement(destroyBotFace, "Frame",{
...
local PivotR = puter.AddElement(destroyBotFace, "Frame",{
	Size = UDim2.fromScale(0.2,1),
...
local MouthL = puter.AddElement(destroyBotFace, "Frame",{
...
local MouthR = puter.AddElement(destroyBotFace, "Frame",{
	Size = UDim2.fromScale(5,1),
