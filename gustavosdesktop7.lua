		...
		local function loadfile(filename, dataz)
			if filename then
				...
				if string.find(filename, "%.lnk") then
					local image2 = screen:CreateElement("ImageLabel", {Size = UDim2.new(0.25, 0, 0.25, 0), Position = UDim2.new(0, 0, 0.75, 0), BackgroundTransparency = 1, Image = "rbxassetid://16180413404", ScaleType = Enum.ScaleType.Fit})
