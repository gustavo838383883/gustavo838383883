...
local success, Error1 = pcall(function()
	...
	function loadingscreen(boolean1, boolean2)
		...
		local spinner = screen:CreateElement("ImageLabel", {Size = UDim2.fromScale(0.1, 0.1), Position = UDim2.fromScale(0.7, 0.4), BackgroundTransparency = 1, ScaleType = Enum.ScaleType.Fit, Image = "rbxassetid://16204406408", TextStrokeColor3 = Color3.new(0,0,0), TextStrokeTransparency = 0.25})
