...
GD7Library: function(): {
	...
	FileExplorer: function(directory: string, functionForSelectingFile: function(name: string, dir: string), selectFile: boolean, disk: Disk),
	...
	filesystem: {Read: function(filename: string,  directory: string, canReturnNil: boolean, disk: Disk): any, Write: function(filename: string, data: any, directory: string, disk: Disk): successString},
	filereader: function(txt: any, nameondisk: string, directory: string, disk: Disk): never,
