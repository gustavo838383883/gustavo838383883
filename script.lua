...
local function loadmenu(screen, disk)
	...
	startmenu.MouseButton1Down:Connect(function()
		if pressed == true then
			...
			local openchangebackimg = screen:CreateElement("TextButton", {Text = "Change Background Image", TextScaled = true, Size = UDim2.new(1, 0, 0.15, 0), Position = UDim2.new(0, 0, 85, 0)})
			local openmediaplayer = screen:CreateElement("TextButton", {Text = "Media Player", TextScaled = true, Size = UDim2.new(1, 0, 0.15, 0), Position = UDim2.new(0, 0, 0.55, 0)})
			local opencalculator = screen:CreateElement("TextButton", {Text = "Calculator", TextScaled = true, Size = UDim2.new(1, 0, 0.15, 0), Position = UDim2.new(0, 0, 0.7, 0)})
