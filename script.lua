		...
		if pressed == true then
			...
			programs.MouseButton1Down:Connect(function()
				...
				if not holdingframe then
					holdingframe = screen:CreateElement("Frame", {Position = UDim2.new(1, 0, 0, 0), Size = UDim2.new(1, 0, 0.45, 0)})
			...
			settings.MouseButton1Down:Connect(function()
				if not holdingframe2 then
					holdingframe2 = screen:CreateElement("Frame", {Position = UDim2.new(1, 0, 0.15, 0), Size = UDim2.new(1, 0, 0.45, 0)})
