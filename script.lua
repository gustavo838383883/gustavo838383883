		...
		if pressed == true then
			...
			if shutdown then
				shutdown.MouseButton1Up:Connect(function()
					...
					holderframe:AddChild(textlabel)
					holderframe:AddChild(closebutton)
					local shutdownbutton = screen:CreateElement("TextButton", {TextScaled = true, Size = UDim2.new(0.5, 0, 0.75, -25), Position = UDim2.new(0, 0, 0.25, 0), TextXAlignment = Enum.TextXAlignment.Left, Text = "Yes"})
					holderframe:AddChild(shutdownbutton)
					local cancelbutton = screen:CreateElement("TextButton", {TextScaled = true, Size = UDim2.new(0.5, 0, 0.75, -25), Position = UDim2.new(0.5, 0, 0.25, 0), TextXAlignment = Enum.TextXAlignment.Left, Text = "No"})
