		...
		if pressed == true then
			...
			programs.MouseButton1Down:Connect(function()
				...
				if not holdingframe then
					...
					local openmediaplayer = screen:CreateElement("TextButton", {Text = "Mediaplayer", TextScaled = true, Size = UDim2.new(1, 0, 0.33, 0), Position = UDim2.new(0, 0, 0.66, 0)})
			...
			settings.MouseButton1Down:Connect(function()
				if not holdingframe2 then
					holdingframe2 = screen:CreateElement("Frame", { Size = UDim2.new(1, 0, 0.45, 0)})
					scrollingframe:AddChild(holdingframe2)
					local openwrite = screen:CreateElement("TextButton", {Text = "Create/Overwrite File", TextScaled = true, Size = UDim2.new(1, 0, 0.33, 0), Position = UDim2.new(1, 0, 0.15, 0)})
					...
					local openchangecolor = screen:CreateElement("TextButton", {Text = "Change Background Color", TextScaled = true, Size = UDim2.new(1, 0, 0.33, 0), Position = UDim2.new(0, 0, 0.66, 0)})
